...
import { Pagination, PaginationEllipsis, PaginationLink, PaginationList, PaginationNext, PaginationPrevious } from 'technoidentity-devfractal';
...
export const PaginationView:React.FC = () => (
    <Pagination alignment="centered">
            ...
            <PaginationList>
                <PaginationLink current aria-label="Goto page 1">1</PaginationLink>
                <PaginationEllipsis/>
