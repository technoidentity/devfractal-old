...
// const noEx = { no: { kind: 'number' } }
// const strEx = { str: { kind: 'string' } }
// const boolEx = { bool: { kind: 'boolean' } }
// const dateEx = { date: { kind: 'date' } }

// test('error from number meta', () => {
//   expect(errorForMT(noEx, { no: true })).toEqual({})
//   expect(validate('100', metaToTcomb(noEx)).isValid()).toBeFalsy()
// })

// test('error from number with refinements', () => {
...
// test('error from array meta with refinements', () => {
...
// test('error from array with differently typed elements', () => {
