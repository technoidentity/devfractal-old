...
export const Email = t.refinement(t.String, s => rEmail.test(s))
export const Url = t.refinement(t.String, s => rUrl.test(s))
...
export const MinDate = (min: Date) =>
  t.refinement(t.Date, d => compareAsc(min, d) <= 0)
export const MaxDate = (max: Date) =>
  t.refinement(t.Date, d => compareAsc(max, d) >= 0)
