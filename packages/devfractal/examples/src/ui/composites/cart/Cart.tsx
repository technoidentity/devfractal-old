...
export const Cart: React.FC = () => {
  const [cart, setCart] = React.useState<readonly CartItem[]>([])
  const products: readonly Product[] = productList

  const addToCart: (productID: number) => void = productId => {
    const newCart: readonly CartItem[] = produce(cart, draft => {
