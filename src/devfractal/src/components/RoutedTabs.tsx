...
export const RoutedTabsItem: React.FunctionComponent<RoutedTabsItemProps> = ({
  value,
  children,
  ...props
}) => (
...
const RoutedTabsWithRouter: React.FunctionComponent<
...
export const RoutedTabs: React.FunctionComponent<RoutedTabsProps> = props => (
