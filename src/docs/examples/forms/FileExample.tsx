...
export const BasicFileExample: React.FC = () => (
  <Section>
...
export const FileModifiersExample: React.FC = () => (
  <Section>
...
export const FileColorExample: React.FC = () => (
  <Section>
...
export const FileSizeExample: React.FC = () => (
  <Section>
...
export const FileAlignmentExample: React.FC = () => (
  <Section>
