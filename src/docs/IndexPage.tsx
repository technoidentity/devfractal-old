...
export const HeroBodySection: React.FunctionComponent = () => (
  <>
...
export const IndexPageHeader: React.FunctionComponent = () => (
  <>
...
export const UIComponentsOverview: React.FunctionComponent = () => (
  <>
...
export const ExploreUIComponents: React.FunctionComponent = () => (
  <>
...
export const BottomSection: React.FunctionComponent = () => (
  <>
